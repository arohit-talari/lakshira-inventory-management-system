...
10. **Generate Report**: a full PDF business-intelligence report (revenue, margin, inventory turnover, customer retention, aging and dead-stock, outstanding balance), with a structured Claude API executive summary and optional email delivery
